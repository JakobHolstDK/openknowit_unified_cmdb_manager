...
try:
    ...
    devices_url = api_url + '/api/dcim/devices/'
    vm_url = api_url + '/api/virtualization/virtual-machines/'
    cluster_url = api_url + '/api/virtualization/clusters/'
    tenant_url = api_url + '/api/tenancy/tenants/'
    role_url = api_url + '/api/dcim/device-roles/'
    site_url = api_url + '/api/dcim/sites/'
    ...
    userconfig = api_url + '/api/users/config/'
    config_context_url = api_url + '/api/circuits/circuit-terminations/'
    circuit_url = api_url + '/api/circuits/circuits/'
    provider_url = api_url + '/api/circuits/providers/'
    interface_url = api_url + '/api/dcim/interfaces/'
    interface_connection_url = api_url + '/api/dcim/interface-connections/'
    device_type_url = api_url + '/api/dcim/device-types/'
    manufacturer_url = api_url + '/api/dcim/manufacturers/'
    platform_url = api_url + '/api/dcim/platforms/'
    rack_url = api_url + '/api/dcim/racks/'
    rack_group_url = api_url + '/api/dcim/rack-groups/'
    rack_role_url = api_url + '/api/dcim/rack-roles/'
    region_url = api_url + '/api/dcim/regions/'
    site_group_url = api_url + '/api/dcim/site-groups/'
    virtual_chassis_url = api_url + '/api/dcim/virtual-chassis/'
    device_role_url = api_url + '/api/dcim/device-roles/'
